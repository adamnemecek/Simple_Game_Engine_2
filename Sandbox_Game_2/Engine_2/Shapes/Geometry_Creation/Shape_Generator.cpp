...
namespace Shapes
{
    namespace Geometry_Creation
    {
        ...
        std::shared_ptr<Shape_Data> Shape_Generator::generate_triangle()
        {
            // create a new storage structure that will persist beyond the function
            std::shared_ptr<Shape_Data> put_data_here =
                std::make_shared<Shape_Data>();
        ...
        std::shared_ptr<Shape_Data> Shape_Generator::generate_plane(const float width, const float length, const uint width_segments, const uint length_segments)
        {
            // create a new storage structure that will persist beyond the function
            std::shared_ptr<Shape_Data> put_data_here =
                std::make_shared<Shape_Data>();
        ...
        std::shared_ptr<Shape_Data> Shape_Generator::generate_circle(const uint num_arc_segments, const float radius)
        {
            // create a new storage structure that will persist beyond the function
            std::shared_ptr<Shape_Data> put_data_here =
                std::make_shared<Shape_Data>();
        ...
        std::shared_ptr<Shape_Data> Shape_Generator::generate_box(const float width, const float length)
        {
            // create a new storage structure that will persist beyond the function
            std::shared_ptr<Shape_Data> put_data_here =
                std::make_shared<Shape_Data>();
        ...
        std::shared_ptr<Shape_Data> Shape_Generator::generate_cube()
        {
            // create a new storage structure that will persist beyond the function
            std::shared_ptr<Shape_Data> put_data_here =
                std::make_shared<Shape_Data>();
        ...
        std::shared_ptr<Shape_Data> Shape_Generator::generate_cylinder(const uint num_arc_segments, const float radius, const uint num_vertical_segments, const float height)
        {
            // create a new storage structure that will persist beyond the function
            std::shared_ptr<Shape_Data> put_data_here =
                std::make_shared<Shape_Data>();
        ...
        std::shared_ptr<Shape_Data> Shape_Generator::generate_sphere(const uint num_arc_segments, const float radius, const uint num_vertical_segments)
        {
            // create a new storage structure that will persist beyond the function
            std::shared_ptr<Shape_Data> put_data_here =
                std::make_shared<Shape_Data>();
